	...
	policies := []struct {
		...
		},
		{
			...
			policy: promptreview.Policy{Role: "editor", MaxTokens: 2500, ForbiddenPhrases: []string{"Chapter 模式", "Arc 模式", "Free 模式"}, Capabilities: []promptreview.Capability{
				...
				{ID: "simulation", Description: "simulation plagiarism check", AnyOf: []string{"画像漂移"}},
			}},
		},
		{
			...
			policy: promptreview.Policy{Role: "architect", MaxTokens: 2500, ForbiddenPhrases: []string{"Chapter 模式", "Arc 模式", "Free 模式"}, Capabilities: []promptreview.Capability{
				...
				{ID: "mode", Description: "current-mode-only planning", AnyOf: []string{"当前 mode contract"}},
				{ID: "simulation", Description: "simulation structure boundary", AnyOf: []string{"结构、悬念、章节钩子、信息释放、反转和回收"}},
				{ID: "persist", Description: "short foundation persistence lifecycle", AnyOf: []string{"premise → characters → world_rules → outline"}},
		...
		},
		{
			...
			policy: promptreview.Policy{Role: "architect", MaxTokens: 2500, ForbiddenPhrases: []string{"Chapter 模式", "Arc 模式", "Free 模式"}, Capabilities: []promptreview.Capability{
				...
				{ID: "mode", Description: "current-mode-only planning", AnyOf: []string{"当前 mode contract"}},
				{ID: "simulation", Description: "simulation structure boundary", AnyOf: []string{"结构、悬念、章节钩子、信息释放、反转和回收"}},
				{ID: "persist", Description: "long foundation persistence lifecycle", AnyOf: []string{"premise → characters → world_rules → layered_outline → update_compass"}},
