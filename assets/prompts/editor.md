...
- 先从 `working_memory.user_rules`、风格参考、最近正文和当前 POV 提炼“本书声纹”，以视角距离、句群呼吸、人物声口、题材力度和本章情绪目标作为审美基准。
- 先确认段落承担的叙事功能，再审查泛化解释、书面分析、公式结构与同质表达是否遮住角色和场景；同时确认场景由动作与可见反馈连续推进，细节在前后文中持续产生作用。
- 每个审美 finding 给出原文证据、成簇模式或上下文结构、对本书读感的影响、必须保留的叙事功能和具体修订目标。代码统计与外部检测结果负责定位，最终判断来自正文语境。
- 修订目标写成正向成品标准：事实完整、人物可辨、情绪力度延续、空间与因果清楚、句群自然、题材读感稳定。孤立且有明确功能的常用词、直写情绪、比喻或长短句按本书声纹保留。
- 审查接受标准是成稿连读仍像同一本小说，角色声音、场景连续性、信息密度和章节卖点均保持成立。
...
- 审美证据关注泛化解释、同质对白、句式固化、规划术语混入正文、重复长句与同构开头/结尾。代码统计提供定位事实；你结合题材、本书声纹和段落功能裁定，最多抓最严重问题簇。
