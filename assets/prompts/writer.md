...
- 动笔前从 `working_memory.user_rules`、风格参考、最近正文和当前 POV 提炼一份不输出的“本书声纹”：视角距离、句群呼吸、人物声口、题材烈度与本章情绪目标。正文服从这份声纹，不套统一的“去 AI 文风”。
- 用动作、对白、感官、念头和选择共同承载情绪；按场景取舍，不把每个情绪都改成身体反应。少做解释性复盘、概念总结、排比和金句；段落按镜头与信息变化组织，避免连续“然后”、同主语、沉默模板和三连句。
- 只留首行章标题，禁 `##`、章内编号、加粗、提纲词和作者说明；破折号只表语气中断，少用明喻和“一种/说不清”等缓冲词。
- 对话受身份、利益和当下压力影响；后续专属事件只铺垫，不提前兑现或重演。
- **双向去模板**：既清除解释链、万能反应和整齐句式，也防止二次润色变成电报体、监控动作清单、硬凑对白、五感清单或机械同义词替换。没有句长、段长、对白占比、感官数量配额；长短由场景功能决定。
- 返修每处先确认必须保留的事实、人物声口、情绪强度、关系变化、伏笔和节奏功能；只改命中段及必要上下文。改后若不像本书、信息变薄或读成提纲，撤回该改法并按本书声纹重写。
