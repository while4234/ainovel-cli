...
func (t *SaveReviewTool) Schema() map[string]any {
	...
	return schema.Object(
		...
		schema.Property("volume", schema.Int("scope=arc_batch 时所属卷号")),
		schema.Property("arc", schema.Int("scope=arc_batch 时所属弧号")),
		schema.Property("batch_from", schema.Int("scope=arc_batch 时本批起始章节")),
		schema.Property("batch_to", schema.Int("scope=arc_batch 时本批结束章节")),
