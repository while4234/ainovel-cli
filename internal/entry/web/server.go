...
func (s *Server) Handler() http.Handler {
	...
	mux.HandleFunc("/api/artwork/config", s.handleArtworkConfig)
	mux.HandleFunc("/api/artwork/config/verify", s.handleArtworkConfigVerify)
	mux.HandleFunc("/api/artwork/models", s.handleArtworkModels)
