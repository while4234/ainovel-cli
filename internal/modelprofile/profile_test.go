...
func TestResolveKnownProfiles(t *testing.T) {
	tests := []struct {
		...
		{model: "deepseek-v4-pro", name: "deepseek-v4-pro", editor: 128_000, mergeRunes: 40_000},
		{model: "GROK-4.5", name: "grok-4.5", editor: 64_000, mergeRunes: 60_000},
		{model: "future-model", name: "default", editor: 128_000, mergeRunes: 70_000},
	}
